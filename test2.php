...
$proxyTranformer = new Transformer('Mindgruve\Gordo\Examples\Encryption\Entities\Message', $entityManager);
...
$proxyTranformer = new Transformer('Mindgruve\Gordo\Tests\TestEntity1', $entityManager);
